...
class Controller {
    ...
    protected $_titre ;
    protected $preg1 = "#^(0[0-9]|1[0-9]|2[0-9]|3[0-1])/(0[1-9]|1[0-2])/(\d{4})$#";
    protected $preg2 = "#^(\d{4})-((0[1-9]|1[0-2]))-(0[0-9]|1[0-9]|2[0-9]|3[0-1])$#";
    protected $preg_email =  " /^[^\W][a-zA-Z0-9_]+(\.[a-zA-Z0-9_]+)*\@[a-zA-Z0-9_]+(\.[a-zA-Z0-9_]+)*\.[a-zA-Z]{2,4}$/ ";
    protected $preg_mdp = "/(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}/";
    protected $erreur ; // Boolean de detection d'erreur.
    protected $liste_niveau ;     
    protected $liste_pays ;
